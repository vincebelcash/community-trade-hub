      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-32">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto font-medium">
            elloopass is built on a modular, decentralized foundation designed for high-throughput trade and community sovereignty.
          </p>
        </div>
          ...
          >
            {[
              { 
                ...
                desc: 'Every elloopass economic cell maintains its own verifiable state, ensuring local control while maintaining global interoperability.',
                color: 'text-blue-600',
                bg: 'bg-blue-600/10'
              },
              { 
