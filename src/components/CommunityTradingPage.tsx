...
export function CommunityTradingPage() {
  ...
  return (
    <div className="pt-24 pb-20 bg-slate-950 min-h-screen text-slate-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl font-black text-white leading-tight tracking-tighter">
              Your Own <span className="text-[#FFD700]">Community</span> Trading Network
            </h1>
            <p className="text-lg text-slate-400 leading-relaxed font-medium">
              HellOOpass provides the technology infrastructure that communities use to run their own closed-loop trading ecosystems. Each community operates independently, with its own members, merchants, and rules.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <div className="bg-slate-900/50 p-4 rounded-2xl border border-slate-800 flex-1">
                <div className="text-[#FFD700] font-black text-sm mb-1 uppercase tracking-widest">The Engine</div>
                <p className="text-xs text-slate-500">HellOOpass powers the background technology and compliance.</p>
              </div>
              <div className="bg-slate-900/50 p-4 rounded-2xl border border-slate-800 flex-1">
                <div className="text-[#008752] font-black text-sm mb-1 uppercase tracking-widest">The Vehicle</div>
                <p className="text-xs text-slate-500">Communities own their brand, members, and local trust.</p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="absolute bottom-6 left-6 right-6 p-6 bg-slate-900/90 backdrop-blur-md rounded-2xl border border-white/10 shadow-2xl">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-slate-500 text-[10px] font-bold uppercase">Community Trader • Senegal</div>
                </div>
      ...
      <section className="bg-slate-900/30 border-y border-slate-800 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-4">The Core Concept</h2>
            <p className="text-slate-400 max-w-2xl mx-auto font-medium">HellOOpass doesn't own the communities; it empowers them with professional-grade financial technology.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: <ShieldCheck className="text-[#008752]" />, title: "White-Labeled", desc: "Each group has its own branded platform and identity." },
              { icon: <Users className="text-[#FFD700]" />, title: "Independent", desc: "Communities onboard their own members and merchants." },
              { icon: <Zap className="text-[#EF3340]" />, title: "Infrastructure", desc: "We provide payment processing and settlement rails." },
              { icon: <Globe className="text-blue-500" />, title: "Closed Loop", desc: "Trust and value remain within the local community ecosystem." }
            ].map((item, i) => (
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/3">
            <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-6">The Complete Flow</h2>
            <p className="text-slate-400 font-medium mb-8">Follow the journey of value from community adoption to merchant settlement.</p>
        ...
        <div className="bg-slate-900 rounded-[3rem] p-8 md:p-16 border border-slate-800 overflow-hidden relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-8">
              <h2 className="text-3xl font-black text-white uppercase tracking-tighter">Multiple Communities, One Platform</h2>
              <p className="text-slate-400 font-medium">HellOOpass can power hundreds of independent communities simultaneously. Each is a separate, closed-loop ecosystem.</p>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-4">Real-World Example</h2>
          <p className="text-slate-400 font-medium">Three Communities, One HellOOpass Platform</p>
        </div>
          ...
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-slate-800 text-[10px] font-black text-slate-500 uppercase tracking-widest">
                <th className="py-4 px-6 text-left">Community</th>
                <th className="py-4 px-6 text-left">Type</th>
                <th className="py-4 px-6 text-left">Members</th>
                <th className="py-4 px-6 text-left">Merchants</th>
                <th className="py-4 px-6 text-left">Unique Feature</th>
              </tr>
            </thead>
            <tbody>
              {[
      ...
      <section className="bg-slate-900/30 border-y border-slate-800 py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-4">Design Principles</h2>
          </div>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="max-w-xl">
            <h2 className="text-3xl font-black text-white uppercase tracking-tighter mb-4">What We Provide</h2>
            <p className="text-slate-400 font-medium">HellOOpass is the end-to-end infrastructure partner for your community economy.</p>
          </div>
      ...
      <section className="px-6 py-20 max-w-5xl mx-auto text-center">
        <div className="bg-gradient-to-br from-[#008752] to-[#005a37] p-12 md:p-20 rounded-[3rem] shadow-2xl shadow-[#008752]/20 relative overflow-hidden">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-8 relative z-10 tracking-tighter">Ready to digitize your community?</h2>
          <p className="text-white/80 text-lg font-medium mb-12 relative z-10 max-w-2xl mx-auto">
            Build your own digital trading ecosystem securely and efficiently with HellOOpass infrastructure.
          </p>
