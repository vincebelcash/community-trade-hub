          ...
          <CardHeader className="relative z-10 pb-0 px-8 pt-8">
            <div className="flex justify-between items-center mb-12">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold uppercase italic tracking-tight text-xl">HellOOpass <span className="text-blue-500">Pay</span></span>
              </div>
              ...
              <div className="relative z-10 h-full flex flex-col justify-between text-white">
                <div className="flex justify-between items-start">
                  <div className="space-y-0.5">
                    <span className="text-white/40 text-[8px] font-bold uppercase tracking-widest">HellOOpass Platinum</span>
