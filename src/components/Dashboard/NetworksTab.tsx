  ...
  return (
    ...
    >
      <header className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold">My Community Networks</h1>
          <p className="text-slate-400 text-sm">Interconnect with the economies that matter to you.</p>
        </div>
        <button 
            onClick={onJoin}
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                      ...
                      <div className="flex flex-wrap items-center gap-8">
                          <div className="text-center md:text-left">
                              <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest">Members</p>
                          ...
                          <div className="text-center md:text-left">
                              <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest">Community Yield</p>
                              <div className="flex items-center gap-1.5">
                          ...
                          <div className="text-center md:text-left">
                              <p className="text-[10px] text-slate-500 font-black uppercase tracking-widest">Trust Status</p>
                              <div className="flex items-center gap-1.5">
      ...
      <div className="p-8 bg-slate-950 border border-dashed border-slate-800 rounded-3xl text-center">
          ...
          <h3 className="text-xl font-bold mb-2">The Magic of Interconnection</h3>
          <p className="text-slate-500 max-w-lg mx-auto mb-6">Connect your networks to allow seamless trade across different community pools. Expand your internal market safely.</p>
          <button 
