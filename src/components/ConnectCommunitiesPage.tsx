      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-black mb-6 tracking-tighter leading-none">
            COMMUNITY <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#008752] via-[#FFD700] to-[#EF3340]">CONNECTIVITY</span>
          </motion.h1>
          ...
          <motion.p variants={itemVariants} className="max-w-2xl mx-auto text-slate-400 text-sm md:text-base leading-relaxed mb-10 normal-case font-medium">
            Communities on HellOOpass are autonomous nodes that can choose to connect with other communities—locally, regionally, or globally—to expand trading opportunities while maintaining their own governance.
          </motion.p>
        </motion.section>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Bilateral Agreements', desc: 'Two communities must both agree to connect.', icon: <Scale size={24} className="text-[#008752]" /> },
              { title: 'Community Control', desc: 'Each community decides who they connect with and on what terms.', icon: <Lock size={24} className="text-[#FFD700]" /> },
              { title: 'No Technical Limits', desc: 'A community can connect with 1 or 1,000+ other communities.', icon: <Zap size={24} className="text-[#EF3340]" /> },
              { title: 'Fully Open Option', desc: 'A community can welcome members from any community worldwide.', icon: <Globe size={24} className="text-blue-400" /> }
            ].map((item, idx) => (
              <motion.div
                key={idx}
          ...
          <div className="flex flex-col lg:flex-row">
            <div className="lg:w-1/2 p-8 md:p-16">
              ...
              <h2 className="text-3xl md:text-4xl font-black mb-8 tracking-tighter leading-none">
                CHAD LIVESTOCK TO <br />
                <span className="text-[#008752]">IVORY COAST</span> MEAT
              </h2>
              ...
              <div className="mt-10 p-6 bg-[#008752]/5 border border-[#008752]/20 rounded-2xl">
                <p className="text-sm font-black text-[#008752]">RESULT: DIRECT, SECURE CROSS-BORDER TRADE BENEFITING BOTH COMMUNITIES.</p>
              </div>
            </div>
        ...
        <section className="mb-24">
          <div className="flex items-center gap-4 mb-12">
            <h2 className="text-2xl font-black tracking-tighter uppercase">Types of Connections</h2>
        ...
        <section className="mb-24 bg-gradient-to-b from-slate-900 to-slate-950 p-12 rounded-[3rem] border border-slate-800">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-black tracking-tighter mb-4">WHAT BECOMES POSSIBLE</h2>
        ...
        <section className="mb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-black mb-8 tracking-tighter leading-tight">
              HOW CONNECTIONS <br />
              <span className="text-[#EF3340]">ARE GOVERNED</span>
            </h2>
            <p className="text-slate-400 normal-case font-medium mb-8 leading-relaxed">
              When communities connect, they agree on a set of automated rules enforced by the HellOOpass platform. These aren't just verbal agreements—they are encoded in the connection's logic.
            </p>
          ...
          <div className="bg-slate-900 p-12 rounded-[2.5rem] border border-slate-800 relative overflow-hidden group">
            ...
            <h3 className="text-6xl font-black tracking-tighter leading-none mb-12 opacity-10">THE VISION</h3>
            <p className="text-2xl md:text-3xl font-black tracking-tighter leading-tight italic text-white mb-12">
              "HellOOpass doesn't build one giant marketplace. It helps thousands of communities build bridges between their marketplaces."
            </p>
            <div className="h-px w-20 bg-[#FFD700] mb-8" />
            <p className="text-sm font-black text-slate-400 normal-case leading-relaxed">
              From village cooperatives to continental trading networks—communities choose their connections, grow at their own pace, and collectively build a Pan-African trading ecosystem.
            </p>
          </div>
        </section>
