      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="max-w-4xl mb-32 text-center mx-auto">
          ...
          <p className="text-xl md:text-2xl text-slate-600 font-medium max-w-2xl mx-auto leading-relaxed">
            The fundamental unit of the HellOOpass ecosystem. Economic cells are autonomous, community-led financial hubs.
          </p>
        </header>
            ...
            {[
              {
                ...
                desc: "Each cell is a self-contained unit with its own treasury and governance rules, secured by the HellOOpass protocol.",
                color: "text-blue-600",
                bg: "bg-blue-600/10"
              },
              {
        ...
        <div className="bg-slate-900 p-12 lg:p-24 rounded-[3rem] text-white text-center shadow-2xl relative overflow-hidden">
          ...
          <p className="text-xl opacity-80 mb-12 max-w-xl mx-auto font-medium">
            Whether you're a small cooperative or a large trade network, HellOOpass cells provide the tools you need to thrive.
          </p>
